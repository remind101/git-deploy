...
describe Git::Deploy::Middleware::HerokuMaintenance, :middleware => true, :sh => true do
  ...
  it 'performs the correct steps in order' do
    step subject, :sh,  'heroku', 'maintenance:on'
    step app,     :call, env
    step subject, :sh,  'heroku', 'maintenance:off'
